...
The use of Forward Error Correction in such an application is motivated by very disturbed channel and low latencies, not allowing for the data retransmission.
