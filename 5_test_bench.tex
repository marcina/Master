...
The physical interface of the test bench has to supply UUT inputs with test vectors and record response of the outputs. This is the principle of the boundary test, where the tester has no access to the internal structure of the tested design. To achieve higher frequencies then the memory interface can withstand, the Test Engine fetches more data at once and shifts them in chunks through the design. The system architecture is shown in \autoref{fig:testbench}.
