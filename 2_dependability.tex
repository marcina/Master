...
To conduct any error correction, the error detection has to take place first. Some systems are armed only with this mechanism. Let's assume that the information leaving the source encoder is a binary sequence that can be divided into blocks of length $k$. Each block is denoted as 
$$u=\{u_1,u_2,...,u_k\}$$ 
